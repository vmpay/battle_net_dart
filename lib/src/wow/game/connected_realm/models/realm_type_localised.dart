...
class RealmTypeLocalised {
  ...
  const RealmTypeLocalised({required this.name, required this.type});
  ...
  RealmTypeLocalised copyWith({NameLocalised? name, RealmType? type}) =>
      RealmTypeLocalised(name: name ?? this.name, type: type ?? this.type);

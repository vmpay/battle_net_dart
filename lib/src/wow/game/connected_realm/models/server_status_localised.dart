...
class ServerStatusLocalised {
  ...
  const ServerStatusLocalised({required this.name, required this.type});
  ...
  ServerStatusLocalised copyWith({NameLocalised? name, ServerStatus? type}) =>
      ServerStatusLocalised(name: name ?? this.name, type: type ?? this.type);
...
final EnumValues<ServerStatus> serverStatusValues = EnumValues<ServerStatus>(
  <String, ServerStatus>{'UP': ServerStatus.UP, 'DOWN': ServerStatus.DOWN},
);

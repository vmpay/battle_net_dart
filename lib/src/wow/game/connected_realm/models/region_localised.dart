...
class RegionLocalised {
  ...
  const RegionLocalised({required this.name, required this.id});
  ...
  RegionLocalised copyWith({NameLocalised? name, int? id}) =>
      RegionLocalised(name: name ?? this.name, id: id ?? this.id);

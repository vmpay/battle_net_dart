...
///
/// This model provides the localized name and the specific type of population
/// for a connected realm.
@immutable
class PopulationTypeLocalised {
  /// Creates an instance of [PopulationTypeLocalised].
  ///
  /// All fields are required.
  const PopulationTypeLocalised({required this.name, required this.type});

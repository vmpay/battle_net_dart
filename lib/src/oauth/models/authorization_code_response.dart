...
///
/// This model contains the access token, token type, expiration time,
/// granted scopes, subject identifier, and ID token.
@immutable
class AuthorizationCodeResponse {
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
    ...
    'scope': scope.map((BattleNetScope e) => e.name).join(' '),
    'sub': sub,
    'id_token': idToken,
  };
